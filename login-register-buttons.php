...
<head>
    ...
    <link rel="stylesheet" href="./libs/css/login-register-buttons.css">
</head>

<body>
    <div class="container">
        <form action="login.php" class="form" id="login">
            ...
            <div class="form__input-group">
                <input type="text" id="uname" name="uname" class="form__input" autofocus placeholder="Username">
        ...
        <form class="form form--hidden" id="createAccount">
            ...
            <div class="form__input-group">
                <input type="password" id="signupPw" class="form__input" autofocus placeholder="Password">
                <div class="form__input-error-message"></div>
            </div>
